...
- [Gear Engine](https://github.com/EyeDaleHim/fnf-Gear-Engine) - Gear Engine is the spiritual successor to Crow Engine. The goal is to provide a data-driven (.json) modding experience.
