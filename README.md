...
- If you're using Psych Engine, you can use [Funkin' Script AutoComplete](https://github.com/Snirozu/Funkin-Script-AutoComplete) that will auto complete functions, variables etc. in your Lua script.
