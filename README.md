...
- [FNF-NewgroundsPort](https://github.com/AngelDTF/FNF-NewgroundsPort) - Rebuild of Funkin' 0.2.8 via reverse engineering.
   - [FNF-Week7-Restoration](https://github.com/trayfellow/FNF-Week7-Restoration) - A fork of the rebuild with few extra things (like restored naughty word censorship and real-time Week 7 cutscenes).
